...
class ImageProcessor:
  ...
  selected_target_color    = (0,0,200)
  passed_up_target_color   = (70,255,0)
  possible_target_color    = (70,0,100)
  ...
  def set_trackbar_position(self):
    # h = getTrackbarPos(self.source_title, "Hue Threshold:")
    # s = getTrackbarPos(self.source_title, "Sat Threshold:")
    # v = getTrackbarPos(self.source_title, "Val Threshold:")

    #self.update_hue_threshold(h)
    self.update_hue_threshold(self.hue_thresh)
    self.update_sat_threshold(self.sat_thresh)
    self.update_val_threshold(self.val_thresh)
...
if '__main__'==__name__:
  ...
  try:
    ...
    img_path = "http://10.32.38.11/jpg/image.jpg"
  print (img_path)
